...
TestGeste.prototype = $extend(utest_Test.prototype,{
	...
	,testRecognise: function() {
		...
		haxe_Log.trace(t.Score,{ fileName : "TestGeste.hx", lineNumber : 16, className : "TestGeste", methodName : "testRecognise"});
		utest_Assert.equals("circle",t.Name,null,{ fileName : "TestGeste.hx", lineNumber : 17, className : "TestGeste", methodName : "testRecognise"});
	}
	,testRecogniseCustom: function() {
		var clocl = Coords.clockcircle.map(function(p) {
			return postite_geom__$CoolPoint_CoolPoint_$Impl_$.fromAnonInt({ x : p.x, y : p.y});
		});
		var t = this.geste.Recognize(postite_geom__$CoolPoint_Points_$Impl_$.fromArrayPress(clocl),false);
		haxe_Log.trace(t.Score,{ fileName : "TestGeste.hx", lineNumber : 24, className : "TestGeste", methodName : "testRecogniseCustom"});
		utest_Assert.notEquals("circle",t.Name,null,{ fileName : "TestGeste.hx", lineNumber : 25, className : "TestGeste", methodName : "testRecogniseCustom"});
	}
	,testRecogniseCustomnotClock: function() {
		var clocl = Coords.notclockcircle.map(function(p) {
			return postite_geom__$CoolPoint_CoolPoint_$Impl_$.fromAnonInt({ x : p.x, y : p.y});
		});
		var t = this.geste.Recognize(postite_geom__$CoolPoint_Points_$Impl_$.fromArrayPress(clocl),false);
		haxe_Log.trace(t.Score,{ fileName : "TestGeste.hx", lineNumber : 33, className : "TestGeste", methodName : "testRecogniseCustomnotClock"});
		haxe_Log.trace(t.Name,{ fileName : "TestGeste.hx", lineNumber : 34, className : "TestGeste", methodName : "testRecogniseCustomnotClock"});
		utest_Assert.equals("circle",t.Name,null,{ fileName : "TestGeste.hx", lineNumber : 35, className : "TestGeste", methodName : "testRecogniseCustomnotClock"});
	}
	,testRecogniseCustomnotClockProtactor: function() {
		...
		haxe_Log.trace(t.Score,{ fileName : "TestGeste.hx", lineNumber : 43, className : "TestGeste", methodName : "testRecogniseCustomnotClockProtactor"});
		haxe_Log.trace(t.Name,{ fileName : "TestGeste.hx", lineNumber : 44, className : "TestGeste", methodName : "testRecogniseCustomnotClockProtactor"});
		utest_Assert.equals("circle",t.Name,null,{ fileName : "TestGeste.hx", lineNumber : 45, className : "TestGeste", methodName : "testRecogniseCustomnotClockProtactor"});
	}
	,__initializeUtest__: function() {
		var _gthis = this;
...
TestGesteStatics.prototype = $extend(utest_Test.prototype,{
	setup: function() {
		TestGesteStatics.path = Coords.small;
	}
	,testTest: function() {
		utest_Assert.isTrue(true,null,{ fileName : "TestGesteStatics.hx", lineNumber : 23, className : "TestGesteStatics", methodName : "testTest"});
	}
	,testDeg2Rad: function() {
		utest_Assert.floatEquals(0.785398,postite_geom_Geste.Deg2Rad(45.0),null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 28, className : "TestGesteStatics", methodName : "testDeg2Rad"});
	}
	,testDistance: function() {
		utest_Assert.floatEquals(282.84,postite_geom_Geste.Distance(TestGesteStatics.p1,TestGesteStatics.p2),1e-2,null,{ fileName : "TestGesteStatics.hx", lineNumber : 33, className : "TestGesteStatics", methodName : "testDistance"});
	}
	,testPathLength: function() {
		utest_Assert.floatEquals(282.84,postite_geom_Geste.PathLength([TestGesteStatics.p1,TestGesteStatics.p2]),1e-2,null,{ fileName : "TestGesteStatics.hx", lineNumber : 38, className : "TestGesteStatics", methodName : "testPathLength"});
	}
	,testPathDistance: function() {
		utest_Assert.floatEquals(223.60679774997897,postite_geom_Geste.PathDistance([TestGesteStatics.p1,TestGesteStatics.p2],postite_geom_Geste.TranslateTo(TestGesteStatics.seg,postite_geom__$CoolPoint_Point_$Impl_$.fromAnonInt({ x : 400, y : 400}))),1e-2,null,{ fileName : "TestGesteStatics.hx", lineNumber : 43, className : "TestGesteStatics", methodName : "testPathDistance"});
	}
	,testBound: function() {
		var r = postite_geom_Geste.BoundingBox(TestGesteStatics.rec);
		utest_Assert.same({ x : 0, y : 0, width : 100, height : 100},r,null,null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 48, className : "TestGesteStatics", methodName : "testBound"});
	}
	,testCentroid: function() {
		var p = postite_geom_Geste.Centroid([TestGesteStatics.p1,TestGesteStatics.p2]);
		utest_Assert.same({ x : 200, y : 300},p,null,null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 58, className : "TestGesteStatics", methodName : "testCentroid"});
	}
	,testDistanceAtAngle: function() {
		utest_Assert.equals(137.79376055283058,postite_geom_Geste.DistanceAtAngle(TestGesteStatics.seg,{ Points : TestGesteStatics.seg},45),null,{ fileName : "TestGesteStatics.hx", lineNumber : 63, className : "TestGesteStatics", methodName : "testDistanceAtAngle"});
	}
	,testBestDistanceAtAngle: function() {
		utest_Assert.equals(7.265398696948875,postite_geom_Geste.DistanceAtBestAngle(TestGesteStatics.seg,{ Points : TestGesteStatics.seg},45.0,90.0,1.0),null,{ fileName : "TestGesteStatics.hx", lineNumber : 68, className : "TestGesteStatics", methodName : "testBestDistanceAtAngle"});
	}
	,testRotateBy: function() {
		utest_Assert.same(postite_geom_Geste.RotateBy(TestGesteStatics.seg,45.0)[0],{ x : 232.55815357163885, y : 162.37744866481518},null,null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 73, className : "TestGesteStatics", methodName : "testRotateBy"});
	}
	,testOptimalCosineDistance: function() {
		utest_Assert.floatEquals(0,postite_geom_Geste.OptimalCosineDistance([0,1],[1,0]),null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 81, className : "TestGesteStatics", methodName : "testOptimalCosineDistance"});
	}
	,testVectorize: function() {
		utest_Assert.isTrue(postite_geom_Geste.Vectorize(TestGesteStatics.seg).length > 1,null,{ fileName : "TestGesteStatics.hx", lineNumber : 86, className : "TestGesteStatics", methodName : "testVectorize"});
	}
	,testTranslateTo: function() {
		...
		utest_Assert.same([{ x : 250, y : 250},{ x : 450, y : 450}],t,null,null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 91, className : "TestGesteStatics", methodName : "testTranslateTo"});
	}
	,testScaleTo: function() {
		...
		utest_Assert.equals(300,Math.min(upPoint.x,upPoint.y),null,{ fileName : "TestGesteStatics.hx", lineNumber : 105, className : "TestGesteStatics", methodName : "testScaleTo"});
	}
	,testIndicativeAngle: function() {
		utest_Assert.floatEquals(0.7853981633974483,postite_geom_Geste.IndicativeAngle(TestGesteStatics.seg),null,null,{ fileName : "TestGesteStatics.hx", lineNumber : 110, className : "TestGesteStatics", methodName : "testIndicativeAngle"});
	}
	,testresample: function() {
		utest_Assert.equals(3,postite_geom_Geste.Resample(TestGesteStatics.seg.slice(),3).length,null,{ fileName : "TestGesteStatics.hx", lineNumber : 116, className : "TestGesteStatics", methodName : "testresample"});
	}
	,testresamplebiggerArray: function() {
		...
		utest_Assert.equals(4,con.length,null,{ fileName : "TestGesteStatics.hx", lineNumber : 127, className : "TestGesteStatics", methodName : "testresamplebiggerArray"});
		utest_Assert.equals(3,r.length,null,{ fileName : "TestGesteStatics.hx", lineNumber : 128, className : "TestGesteStatics", methodName : "testresamplebiggerArray"});
	}
	,testResampleSimple: function() {
		...
		utest_Assert.equals(20,n.length,null,{ fileName : "TestGesteStatics.hx", lineNumber : 134, className : "TestGesteStatics", methodName : "testResampleSimple"});
		utest_Assert.equals(dix[0],n[0],null,{ fileName : "TestGesteStatics.hx", lineNumber : 135, className : "TestGesteStatics", methodName : "testResampleSimple"});
	}
	,__initializeUtest__: function() {
		var _gthis = this;
		var init = utest_Test.prototype.__initializeUtest__.call(this);
...
TestResample.prototype = $extend(utest_Test.prototype,{
	testCircle: function() {
		haxe_Log.trace("circl",{ fileName : "TestResample.hx", lineNumber : 29, className : "TestResample", methodName : "testCircle"});
		var _this = postite_geom_UnistrokePatterns.unimap;
		utest_Assert.equals(64,postite_geom_Geste.Resample(__map_reserved["circle"] != null ? _this.getReserved("circle") : _this.h["circle"],64).length,null,{ fileName : "TestResample.hx", lineNumber : 32, className : "TestResample", methodName : "testCircle"});
	}
	,__initializeUtest__: function() {
		var _gthis = this;
		var init = utest_Test.prototype.__initializeUtest__.call(this);
...
postite_StepIterator.__name__ = ["postite","StepIterator"];
postite_StepIterator.prototype = {
	...
	,__class__: postite_StepIterator
};
...
postite_geom_Geste.OptimalCosineDistance = function(v1,v2) {
	...
	while(_g_index < end) {
		...
		try {
			...
			haxe_Log.trace("eer" + Std.string((msg instanceof js__$Boot_HaxeError) ? msg.val : msg),{ fileName : "Geste.hx", lineNumber : 223, className : "postite.geom.Geste", methodName : "OptimalCosineDistance"});
		}
	}
...
postite_geom_Geste.prototype = {
	...
	,Recognize: function(points,useProtractor) {
		...
		var b = Infinity;
		haxe_Log.trace(this.Unistrokes.length,{ fileName : "Geste.hx", lineNumber : 36, className : "postite.geom.Geste", methodName : "Recognize"});
		var u = -1;
		var _g1 = 0;
...
utest_TestResult.ofFailedSetupClass = function(testCase,assertation) {
	var r = new utest_TestResult();
	var path = Type.getClassName(testCase == null ? null : js_Boot.getClass(testCase)).split(".");
	r.cls = path.pop();
	r.pack = path.join(".");
	r.method = "setup";
...
utest_ui_common_ResultAggregator.prototype = {
	...
	,checkNonITest: function() {
		...
		var total = 0;
		var _g1 = 0;
		var _g = this.runner.length;
		while(_g1 < _g) {
			var fixture = this.runner.getFixture(_g1++);
			if(!fixture.isITest) {
				++total;
				if(first == null) {
					var o = fixture.target;
					first = Type.getClassName(o == null ? null : js_Boot.getClass(o));
				}
			}
		}
		if(total > 0) {
...
utest_ui_text_HtmlReport.prototype = {
	...
	,_handler: function(report) {
		...
		if(window.document.readyState == "loading") {
			...
			var onReadyStateChange1 = onReadyStateChange;
			window.document.addEventListener("readystatechange",onReadyStateChange1);
			return;
		}
